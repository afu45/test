...
I18N.zh = {
    ...
    "page-dashboard": { // 已登录的首页 - 仪表板(含组织)
        "static": { // 静态翻译
            ...
            "Using the Hello World guide, you’ll create a repository, start a branch, write comments, and open a pull request.": "使用 Hello World 指南，您将创建一个仓库，开始一个分支，写评论，并创建一个拉取请求。",
